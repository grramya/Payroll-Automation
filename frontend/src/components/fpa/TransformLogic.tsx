...
const SOURCE_COLORS: Record<string, SourceStyle> = {
...
function sourceStyle(src: string): SourceStyle {
          ...
          <TableBody>
            {LOGIC.map((row, i) => {
              ...
              return (
                ...
                >
                  <TableCell sx={{ fontWeight: 600, color: "text.primary", whiteSpace: "nowrap", fontSize: "0.8rem", py: 1, borderBottom: "1px solid #F1F5F9" }}>
                    {row.target}
                  </TableCell>
