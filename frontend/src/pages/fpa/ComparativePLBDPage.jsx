...
const ROW_STYLES = {
  section:     { bg: "#0F172A", labelColor: "#fff",     valColor: "#fff",     fontWeight: 700, fontSize: "0.78rem", height: 28 },
  ...
  grand_total: { bg: "#7C2D12", labelColor: "#fff",     valColor: "#fff",     fontWeight: 700, fontSize: "0.78rem", height: 28, borderTop: "2px solid #9A3412" },
  metric:      { bg: "#FFF7ED", labelColor: "#C2410C",  valColor: "#C2410C",  fontWeight: 400, fontSize: "0.72rem", height: 20, italic: true },
...
function buildColumnGroups(monthCols, fourQuarters, selectedYear) {
  return [
    { label: "Months",   cols: monthCols,                                          color: "#7C2D12" },
    { label: "Quarters", cols: fourQuarters,                                       color: "#374151" },
    { label: "Year",     cols: [String(selectedYear - 1), String(selectedYear)],   color: "#7C2D12" },
  ];
}
            ...
            <Box sx={{ display: "flex", alignItems: "flex-end", gap: 1.5, flexWrap: "wrap" }}>
                  ...
                  <Box key={label}>
                    ...
                    <Box
                      sx={{
                        ...
                        "&:focus-within": { borderColor: "#DC2626", boxShadow: "0 0 0 2px rgba(220,38,38,0.12)" },
                      }}
                    >
                      <input
                        type="date"
              ...
              {compPlBdBlob && (
                <Button
                  ...
                  sx={{ background: "linear-gradient(135deg,#DC2626,#B91C1C)", whiteSpace: "nowrap" }}
                >
                  Download .xlsx
                </Button>
              )}
